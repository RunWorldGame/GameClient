...
public class GameClient : MonoBehaviour
{
    ...
    [SerializeField] private Transform objectsToSync;
    
    
    public Queue<ObjectToSpawn> BufferSpawnElements;

    [SerializeField] private List<NetworkObject> _objectsToSync;
    ...
    private void Awake()
    {
        _objectsToSync = new List<NetworkObject>();
    ...
    private void Update()
    {
       ...
       { 
           ...
           var gameObj = _gameObjectInitializer.instantiateGameObjectMainThread(BufferSpawnElements.Dequeue());
           ...
           _objectsToSync.Add(gameObj.GetComponent<NetworkObject>());
           Debug.Log("added a new gameobject");
        }
       
        if(_transFormUpdater != null)
        {     
            
            objectsToSync.position = _transFormUpdater.currentNetworkConnectionPosition;
            //Debug.Log(_transFormUpdater.currentNetworkConnectionPosition);
        }
